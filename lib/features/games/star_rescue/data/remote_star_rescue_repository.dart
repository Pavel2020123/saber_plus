...
import 'star_rescue_resume_store.dart';

class RemoteStarRescueRepository implements StarRescueRepository {
  RemoteStarRescueRepository(this.dio, this.store, {required this.scope});
  final Dio dio;
  final StarRescueResumeStore store;
  final String scope;
  bool _disposed = false;
  bool _busy = false;
  bool _restored = false;
  StarRescueAttempt? _current;
  StarRescuePendingAnswer? _pending;
  @override
  bool get isDemo => false;
  @override
  StarRescueAttempt? get current => _current;
  @override
  StarRescuePendingAnswer? get pending => _pending;
  void dispose() {
    _disposed = true;
    _current = null;
    _pending = null;
  ...
  String _path(String id) =>
      '/rescate-estrellas/intentos/${Uri.encodeComponent(id)}';
  Future<StarRescueAttempt?> _request(
    String path, {
    ...
    try {
      ...
      final result = StarRescueAttempt.fromJson(
  ...
  @override
  Future<StarRescueAttempt?> restore() => _exclusive(() async {
    ...
    StarRescueAttempt? result = await _request(
      '/rescate-estrellas/intentos/activo',
      nullable: true,
    );
  ...
  @override
  Future<StarRescueAttempt> abandon(String attemptId) => _exclusive(() async {
