...
import '../features/institutions/presentation/institution_approval_page.dart';
    ...
    routes: [
            ...
            routes: [
              GoRoute(
                ...
                routes: [
                  ...
                  _animatedRoute(
                    path: 'summit',
                    builder: (context, state) => const SummitPage(),
                  ),
                  _animatedRoute(
                    path: 'trivia-rush',
      ...
      GoRoute(
        ...
        routes: [
          _animatedRoute(
            path: 'verification',
            builder: (_, _) => const InstitutionApprovalPage(),
          ),
          _animatedRoute(
            path: 'administration',
          ...
          _animatedRoute(
            ...
            builder: (context, state) => TeacherStudentEvidencePage(
