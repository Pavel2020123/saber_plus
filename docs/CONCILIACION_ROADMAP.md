...
**Última subetapa implementada: 7F-C3-D2-C. Próxima: continuar 7F-C3-D2.**
...
- C3-D2-C: API de reclasificación explícita para preguntas sin uso registrado;
  protege el historial bloqueando las utilizadas/publicadas. Sin pantalla ni
